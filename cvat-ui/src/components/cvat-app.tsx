...
import ClassDistributionPage from './class-distribution/class-distribution-page';
                            ...
                            <Layout>
                                ...
                                <Layout.Content style={{ height: '100%', position: 'relative' }}>
                                    ...
                                    <Switch>
                                        ...
                                        <Route exact path='/tasks/:tid/class-distribution' component={ClassDistributionPage} />
